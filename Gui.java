...
public class Gui implements ActionListener {
    ...
    int totalCustomer, Stack<CustomerInformation> completedStack){
        ...
        labelQueue2 = new JLabel("Queue: " + String.valueOf(queue2), SwingConstants.CENTER);
        panelQueue2.add(labelQueue2, BorderLayout.CENTER);

        // Panel Queue 3
        panelQueue3 = new JPanel();
        panelQueue3.setBounds(360, 70, 150, 30);
        panelQueue3.setLayout(new BorderLayout());
        labelQueue3 = new JLabel("Queue: " + String.valueOf(queue3), SwingConstants.CENTER);
        panelQueue3.add(labelQueue3, BorderLayout.CENTER);
